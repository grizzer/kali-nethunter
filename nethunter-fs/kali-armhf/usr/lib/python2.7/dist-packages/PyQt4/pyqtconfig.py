...
_pkg_config = {
    ...
    'pyqt_config_args':  '--confirm-license --verbose -q /usr/bin/qmake-qt4 -c -j 10 LIBDIR_QT=/usr/lib STRIP= MOC=moc-qt4 LIBS_OPENGL= LIBS_X11= LIBS_THREAD= CFLAGS= -g -O2 -fstack-protector-strong -Wformat -Werror=format-security  -D_FORTIFY_SOURCE=2 CXXFLAGS= -g -O2 -fstack-protector-strong -Wformat -Werror=format-security  -D_FORTIFY_SOURCE=2 LFLAGS= -Wl,-z,relro -Wl,-O1 -m /usr/lib/python2.7/config-arm-linux-gnueabihf -d /usr/lib/python2.7/dist-packages --dbus /usr/include/dbus-1.0',
    ...
    'pyqt_sip_flags':    '-x VendorID -t WS_X11 -x PyQt_NoPrintRangeBug -x PyQt_qreal_double -t Qt_4_8_6 -x Py_v3 -g',
    ...
    'qt_lib_dir':        '/usr/lib/arm-linux-gnueabihf',
    'qt_threaded':       1,
    'qt_version':        0x040806,
    'qt_winconfig':      'shared'
}
